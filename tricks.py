...
parser.add_argument('--root_dir', default='F:\pycharm\Project\yolov5-master with attention\mydata',type=str, help="root path of images and labels, include ./images and ./labels and classes.txt")
parser.add_argument('--save_path', type=str,default='my-data_val.json', help="if not split the dataset, give a path to a json file")
