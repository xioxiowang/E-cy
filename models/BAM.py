...
class ChannelAttention(nn.Module):
    def __init__(self, channel=512, reduction=16, num_layers=3):
        super().__init__()
        ...
        # self.ca.add_module('Jinyanfei',nn.Linear(gate_channels[0], gate_channels[1]))
...
class SpatialAttention(nn.Module):
    # def __init__(self, channel=512, reduction=16, num_layers=3, dia_val=2):
    def __init__(self, channel=512, reduction=16, num_layers=3, dia_val=2):
        super().__init__()
